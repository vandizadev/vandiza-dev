    ...
    reset(propertiesToKeep) {
        this.wrap(()=>{
            const allPropertiesToKeep = [
                ...
                external_types_js_namespaceObject.PostHogPersistedProperty.AiCaptureQueue,
    ...
    async _flagsAsync(options) {
        ...
        this._flagsResponsePromise = this._initPromise.then(async ()=>{
            ...
            if (pendingRequest) {
                ...
                }).then((res)=>pendingRequest.waiters.forEach((w)=>w.resolve(res))).catch((e)=>pendingRequest.waiters.forEach((w)=>w.reject(e)));
            }
        });

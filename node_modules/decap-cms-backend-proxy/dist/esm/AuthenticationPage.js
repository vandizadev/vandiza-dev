...
export default class AuthenticationPage extends React.Component {
  ...
  render() {
    ...
    return _jsxs(StyledAuthenticationPage, {
      children: [renderPageLogo(config.logo?.src || config.logo_url), _jsx(LoginButton, {
        disabled: inProgress,
        onClick: this.handleLogin,
        children: inProgress ? t('auth.loggingIn') : t('auth.login')
      }), config.site_url && _jsx(GoBackButton, {

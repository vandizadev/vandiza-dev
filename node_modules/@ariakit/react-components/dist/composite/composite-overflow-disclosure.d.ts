 ...
 * ```
 */
export declare const useCompositeOverflowDisclosure: import("@ariakit/react-utils").Hook<"button", CompositeOverflowDisclosureOptions<"button">>;
/**
 ...
 * ```
 */
export declare const CompositeOverflowDisclosure: (props: CompositeOverflowDisclosureProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

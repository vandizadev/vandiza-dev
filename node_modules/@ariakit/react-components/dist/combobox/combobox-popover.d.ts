...
import { n as CompositeTypeaheadOptions } from "../composite-typeahead-CcgA3PL9.js";
import { n as PopoverOptions } from "../popover-ogM2HryK.js";
import { Props } from "@ariakit/react-utils";
import { ElementType, KeyboardEvent as KeyboardEvent$1 } from "react";
import { BooleanOrCallback } from "@ariakit/utils";
//#region src/combobox/combobox-popover.d.ts
 ...
 * ```
 */
export declare const useComboboxPopover: import("@ariakit/react-utils").Hook<"div", ComboboxPopoverOptions<"div">>;
/**
 ...
 * ```
 */
export declare const ComboboxPopover: (props: ComboboxPopoverProps<"div">) => import("react").JSX.Element | null;
export interface ComboboxPopoverOptions<T extends ElementType = TagName> extends ComboboxListOptions<T>, Omit<PopoverOptions<T>, "store"> {
   ...
   * selections.
   */
  resetOnEscape?: BooleanOrCallback<KeyboardEvent | KeyboardEvent$1>;
}
export type ComboboxPopoverProps<T extends ElementType = TagName> = Props<T, ComboboxPopoverOptions<T>>;
//#endregion
//# sourceMappingURL=combobox-popover.d.ts.map
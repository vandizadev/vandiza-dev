...
* ```
*/
const useComboboxPopover = createHook(function useComboboxPopover({ store, modal, tabIndex, alwaysVisible, resetOnEscape, autoFocusOnHide = true, hideOnInteractOutside = true, ...props }) {
	...
	const treeSnapshotKey = useStoreState(store.tag, ["renderedItems"], (state) => state?.renderedItems.length);

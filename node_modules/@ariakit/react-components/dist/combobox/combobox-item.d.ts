 ...
 * ```
 */
export declare const useComboboxItem: import("@ariakit/react-utils").Hook<"div", ComboboxItemOptions<"div">>;
/**
 ...
 * ```
 */
export declare const ComboboxItem: (props: ComboboxItemProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

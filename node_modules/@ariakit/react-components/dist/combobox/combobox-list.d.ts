 ...
 * ```
 */
export declare const useComboboxList: import("@ariakit/react-utils").Hook<"div", ComboboxListOptions<"div">>;
/**
 ...
 * ```
 */
export declare const ComboboxList: (props: ComboboxListProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

import { s as ComboboxStoreState, t as ComboboxStore } from "../combobox-store-HDsRsPSm.js";
 ...
 * ```
 */
export declare const useCombobox: import("@ariakit/react-utils").Hook<"input", ComboboxOptions<"input">>;
/**
 ...
 * ```
 */
export declare const Combobox: (props: ComboboxProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;
export interface ComboboxOptions<T extends ElementType = TagName> extends CompositeOptions<T> {
  /**

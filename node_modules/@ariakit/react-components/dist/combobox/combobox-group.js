...
const useComboboxGroup = createHook(function useComboboxGroup({ store, ...props }) {
	...
	if (getPopupRole(contentElement) === "grid") props = {
		role: "rowgroup",
		...props
	};

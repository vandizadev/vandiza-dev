...
import { t as SelectStore } from "../select-store-DRCGwW3T.js";
 ...
 * ```
 */
export declare const useSelectList: import("@ariakit/react-utils").Hook<"div", SelectListOptions<"div">>;
/**
 ...
 * ```
 */
export declare const SelectList: (props: SelectListProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

...
import { SelectScopedContextProvider, useSelectProviderContext } from "./select-context.js";
...
import { disabledFromProps, getPopupRole, invariant, queueBeforeEvent, toArray } from "@ariakit/utils";
...
const useSelect = createHook(function useSelect({ store, name, form, required, showOnKeyDown = true, moveOnKeyDown = true, toggleOnPress = true, toggleOnClick = toggleOnPress, ...props }) {
	...
	props = useWrapElement(props, (element) => {
		...
		return /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsxs("select", {
			...
			children: [toArray(value).map((value) => {

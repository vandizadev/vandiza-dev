 ...
 * ```
 */
export declare const useSelectItem: import("@ariakit/react-utils").Hook<"div", SelectItemOptions<"div">>;
/**
 ...
 * ```
 */
export declare const SelectItem: (props: SelectItemProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

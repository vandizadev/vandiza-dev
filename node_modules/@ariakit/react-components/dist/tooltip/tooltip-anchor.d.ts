 ...
 * ```
 */
export declare const useTooltipAnchor: import("@ariakit/react-utils").Hook<"div", TooltipAnchorOptions<"div">>;
/**
 ...
 * ```
 */
export declare const TooltipAnchor: (props: TooltipAnchorProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

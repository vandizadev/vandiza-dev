 ...
 * ```
 */
export declare const useRadio: import("@ariakit/react-utils").Hook<"input", RadioOptions<"input">>;
/**
 ...
 * ```
 */
export declare const Radio: (props: RadioProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

...
import { t as ToolbarStore } from "../toolbar-store-nJ6t0Bzm.js";
 ...
 * ```
 */
export declare const useToolbarItem: import("@ariakit/react-utils").Hook<"button", ToolbarItemOptions<"button">>;
/**
 ...
 * ```
 */
export declare const ToolbarItem: (props: ToolbarItemProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

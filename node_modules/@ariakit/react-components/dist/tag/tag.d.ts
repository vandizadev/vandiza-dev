 ...
 * ```
 */
export declare const useTag: import("@ariakit/react-utils").Hook<"div", TagOptions<"div">>;
/**
 ...
 * ```
 */
export declare const Tag: (props: TagProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

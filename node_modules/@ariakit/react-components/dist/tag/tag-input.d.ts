import { t as TagStore } from "../tag-store-CcLMUQXF.js";
 ...
 * ```
 */
export declare const useTagInput: import("@ariakit/react-utils").Hook<"input", TagInputOptions<"input">>;
/**
 ...
 * ```
 */
export declare const TagInput: (props: TagInputProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

 ...
 * ```
 */
export declare const useTagList: import("@ariakit/react-utils").Hook<"div", TagListOptions<"div">>;
/**
 ...
 * ```
 */
export declare const TagList: (props: TagListProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

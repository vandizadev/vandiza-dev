 ...
 * ```
 */
export declare const useHovercard: import("@ariakit/react-utils").Hook<"div", HovercardOptions<"div">>;
/**
 ...
 * ```
 */
export declare const Hovercard: (props: HovercardProps<"div">) => import("react").JSX.Element | null;

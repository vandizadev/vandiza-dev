 ...
 * ```
 */
export declare const useTab: import("@ariakit/react-utils").Hook<"button", TabOptions<"button">>;
/**
 ...
 * ```
 */
export declare const Tab: (props: TabProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

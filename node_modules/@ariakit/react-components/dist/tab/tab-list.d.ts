 ...
 * ```
 */
export declare const useTabList: import("@ariakit/react-utils").Hook<"div", TabListOptions<"div">>;
/**
 ...
 * ```
 */
export declare const TabList: (props: TabListProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

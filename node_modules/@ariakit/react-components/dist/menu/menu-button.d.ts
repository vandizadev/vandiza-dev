...
import { n as HovercardAnchorOptions } from "../hovercard-anchor-CCIZkNaF.js";
 ...
 * ```
 */
export declare const useMenuButton: import("@ariakit/react-utils").Hook<TagName, MenuButtonOptions<TagName>>;
/**
 ...
 * ```
 */
export declare const MenuButton: (props: MenuButtonProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;

import { i as CompositeStoreOptions, n as CompositeStoreFunctions, r as CompositeStoreItem, s as CompositeStoreState } from "../composite-store-C5m2qUBo.js";
import { a as PopoverStoreState, n as PopoverStoreFunctions, r as PopoverStoreOptions } from "../popover-store-D7hAv3_R.js";
import { t as TagStore } from "../tag-store-DG5sziVc.js";
...
export interface ComboboxStoreOptions<T extends ComboboxStoreSelectedValue = ComboboxStoreSelectedValue> extends StoreOptions<ComboboxStoreState<T>, "compositeElementInFocusOrder" | "focusLoop" | "focusWrap" | "orientation" | "virtualFocus" | "inputValue" | "value" | "selectedValue" | "selectOnMove" | "resetValueOnHide" | "resetValueOnSelect">, CompositeStoreOptions<ComboboxStoreItem>, PopoverStoreOptions {
  /** @default null */

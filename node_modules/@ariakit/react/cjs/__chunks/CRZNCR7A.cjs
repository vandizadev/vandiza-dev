...
// ../ariakit-react-components/dist/__chunks/DjvJNLSl.js
...
var useCheckbox = _TJ2QLEWIcjs.createHook.call(void 0, function useCheckbox2({ store, name, value: valueProp, checked: checkedProp, defaultChecked, ...props }) {
  const context = useCheckboxContext();
  store = store || context;
  const [_checked, setChecked] = _react.useState.call(void 0, defaultChecked != null ? defaultChecked : false);
  const checked = _YNVZ54CPcjs.useStoreState.call(void 0, store, ["value"], (state) => {
  ...
  const nativeCheckbox = isNativeCheckbox(_TJ2QLEWIcjs.useTagName.call(void 0, ref, TagName), props.type);
  ...
  props = _TJ2QLEWIcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _X4U3XKYQcjs.CheckboxCheckedContext.Provider, {
    value: isChecked,
    children: element
  }), [isChecked]);
  props = {
  ...
  props = _MMRXZG5Gcjs.useCommand.call(void 0, {
...
var Checkbox = _TJ2QLEWIcjs.forwardRef.call(void 0, function Checkbox2(props) {
...
function createCheckboxStore(props = {}) {
  ...
  const initialState = { value: _TJ2QLEWIcjs.defaultValue.call(void 0, props.value, syncState == null ? void 0 : syncState.value, props.defaultValue, false) };
  const checkbox = _YNVZ54CPcjs.createStore.call(void 0, initialState, props.store);
  return {
    ...checkbox,
...
function useCheckboxStore(props = {}) {
  const [store, update] = _YNVZ54CPcjs.useStore.call(void 0, createCheckboxStore, props);

...
// ../ariakit-react-components/dist/__chunks/B3k5_R1L.js
...
function getOverflowPaddingValue(padding) {
  ...
  return Math.max((_a = padding.left) != null ? _a : 0, (_b = padding.right) != null ? _b : 0);
}
...
function getFlipMiddleware(props) {
  ...
  _TJ2QLEWIcjs.invariant.call(void 0, !fallbackPlacements || fallbackPlacements.every(isValidPlacement), process.env.NODE_ENV !== "production" && "`flip` expects a spaced-delimited list of placements");
  return flip2({
...
function getSizeMiddleware(props, shouldCancel) {
  return size2({
    ...
    apply({ elements, availableWidth, availableHeight, rects }) {
      if (shouldCancel == null ? void 0 : shouldCancel()) return;
...
var usePopover = _TJ2QLEWIcjs.createHook.call(void 0, function usePopover2({ store, modal = false, portal = modal, preserveTabOrder = true, autoFocusOnShow = true, wrapperProps, fixed = false, flip: flip3 = true, shift: shift3 = 0, slide = true, overlap = false, sameWidth = false, fitViewport = false, gutter, arrowPadding = 4, overflowPadding = 8, getAnchorRect, updatePosition, ...props }) {
  var _a, _b, _c, _d;
  const context = _UYZAI6KFcjs.usePopoverProviderContext.call(void 0, );
  store = store || context;
  _TJ2QLEWIcjs.invariant.call(void 0, store, process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component.");
  const arrowElement = _YNVZ54CPcjs.useStoreState.call(void 0, store, "arrowElement");
  const anchorElement = _YNVZ54CPcjs.useStoreState.call(void 0, store, "anchorElement");
  const shouldPreserveTabOrder = preserveTabOrder && portal && !modal;
  const disclosureElement = _YNVZ54CPcjs.useStoreState.call(void 0, store, shouldPreserveTabOrder ? ["disclosureElement"] : [], (state) => shouldPreserveTabOrder ? state.disclosureElement : null);
  const popoverElement = _YNVZ54CPcjs.useStoreState.call(void 0, store, "popoverElement");
  ...
  const rendered = _YNVZ54CPcjs.useStoreState.call(void 0, store, "rendered");
  ...
  const getAnchorRectProp = _TJ2QLEWIcjs.useEvent.call(void 0, getAnchorRect);
  const updatePositionProp = _TJ2QLEWIcjs.useEvent.call(void 0, updatePosition);
  const hasCustomUpdatePosition = !!updatePosition;
  const overflowPaddingTop = typeof overflowPadding === "number" ? overflowPadding : (_a = overflowPadding.top) != null ? _a : 0;
  const overflowPaddingRight = typeof overflowPadding === "number" ? overflowPadding : (_b = overflowPadding.right) != null ? _b : 0;
  const overflowPaddingBottom = typeof overflowPadding === "number" ? overflowPadding : (_c = overflowPadding.bottom) != null ? _c : 0;
  const overflowPaddingLeft = typeof overflowPadding === "number" ? overflowPadding : (_d = overflowPadding.left) != null ? _d : 0;
  const hiddenWhileUnmounted = !mounted && _GZ52SB2Ncjs.isHidden.call(void 0, mounted, props.hidden, props.alwaysVisible);
  _TJ2QLEWIcjs.useSafeLayoutEffect.call(void 0, () => {
    if (mounted) store == null ? void 0 : store.setState("unstable_placing", true);
    ...
    const update = async () => {
      ...
      try {
        ...
        if (placed && !shouldCancelUpdate()) store == null ? void 0 : store.setState("unstable_placing", false);
        throw error;
      }
      if (shouldCancelUpdate()) return;
      store == null ? void 0 : store.setState("unstable_placing", false);
    };
  ...
  _TJ2QLEWIcjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    placingWriters.set(currentStore, ((_a2 = placingWriters.get(currentStore)) != null ? _a2 : 0) + 1);
    const desync = _YNVZ54CPcjs.sync.call(void 0, currentStore, ["mounted"], (state) => {
      currentStore.setState("unstable_placing", state.mounted);
    });
    return () => {
      var _a3;
      desync();
      placingWriters.set(currentStore, ((_a3 = placingWriters.get(currentStore)) != null ? _a3 : 1) - 1);
      queueMicrotask(() => {
  ...
  props = _TJ2QLEWIcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
    ...wrapperProps,
    style: {
      position,
      top: 0,
  ...
  props = _TJ2QLEWIcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _UYZAI6KFcjs.PopoverScopedContextProvider, {
    value: store,
    children: element
  }), [store]);
  props = {
  ...
  props = _PCUV66ZEcjs.useDialog.call(void 0, {
    store,
    modal,
    portal,
    preserveTabOrder,
...
var Popover = _PCUV66ZEcjs.createDialogComponent.call(void 0, _TJ2QLEWIcjs.forwardRef.call(void 0, function Popover2(props) {
  const htmlProps = usePopover(props);
  return _TJ2QLEWIcjs.createElement.call(void 0, TagName, htmlProps);
}), _UYZAI6KFcjs.usePopoverProviderContext);

// ../ariakit-components/dist/popover/popover-store.js
function createPopoverStore({ popover: otherPopover, ...props } = {}) {
  const store = _YNVZ54CPcjs.mergeStore.call(void 0, props.store, _YNVZ54CPcjs.omit.call(void 0, otherPopover, [
    "arrowElement",
    "anchorElement",
    "contentElement",
    "popoverElement",
  ...
  const dialog = _PCUV66ZEcjs.createDialogStore.call(void 0, {
    ...props,
    store
  });
  const placement = _TJ2QLEWIcjs.defaultValue.call(void 0, props.placement, syncState == null ? void 0 : syncState.placement, "bottom");
  const initialState = {
    ...dialog.getState(),
    placement,
    currentPlacement: placement,
    anchorElement: _TJ2QLEWIcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.anchorElement, null),
    popoverElement: _TJ2QLEWIcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.popoverElement, null),
    arrowElement: _TJ2QLEWIcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.arrowElement, null),
    rendered: /* @__PURE__ */ Symbol("rendered"),
    unstable_placing: false
  };
  const popover = _YNVZ54CPcjs.createStore.call(void 0, initialState, dialog, store);
  let syncedAnchorElement = initialState.anchorElement === initialState.disclosureElement ? initialState.anchorElement : null;
  _YNVZ54CPcjs.setup.call(void 0, popover, () => _YNVZ54CPcjs.sync.call(void 0, popover, ["anchorElement", "disclosureElement"], (state) => {
...
function usePopoverStoreProps(store, update, props) {
  _TJ2QLEWIcjs.useUpdateEffect.call(void 0, update, [props.popover, update]);
  _YNVZ54CPcjs.useStoreProps.call(void 0, store, props, "placement");
  return _PCUV66ZEcjs.useDialogStoreProps.call(void 0, store, update, props);
}
function usePopoverStore(props = {}) {
  const [store, update] = _YNVZ54CPcjs.useStore.call(void 0, createPopoverStore, props);
...
exports.getBasePlacement = getBasePlacement; exports.usePopover = usePopover; exports.Popover = Popover; exports.createPopoverStore = createPopoverStore; exports.usePopoverStoreProps = usePopoverStoreProps; exports.usePopoverStore = usePopoverStore;

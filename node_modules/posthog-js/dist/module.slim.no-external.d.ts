...
import { ErrorTracking, SurveyResponseValue as SurveyResponseValue$1, SurveyPosition as SurveyPosition$1, LogSdkContext, Logger as Logger$1 } from '@posthog/core';
...
declare class BrowserClientAdapter implements Client, Disposable {
    ...
    getExtension<T extends Extension$1>(token: ExtensionToken<T>): T | undefined;
    getExtension<T extends Extension$1 = Extension$1>(name: string): T | undefined;
...
declare class BrowserAutocapture extends Autocapture {
    instance: PostHog;
    constructor(instance: PostHog);
}
...
declare const AnalyticsExtensions: {
    readonly autocapture: typeof BrowserAutocapture;
...
declare const SurveysExtensions: {
    readonly featureFlags: typeof PostHogFeatureFlags;
    readonly surveys: typeof BrowserSurveys;
};

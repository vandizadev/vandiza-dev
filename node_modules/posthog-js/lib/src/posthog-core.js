...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._reset = function (reset_device_id, isConsentTransition, bootstrap) {
        ...
        try {
            ...
            (_m = this.featureFlags) === null || _m === void 0 ? void 0 : _m.reset();
            (_o = this.conversations) === null || _o === void 0 ? void 0 : _o.reset();
            (_p = this.logs) === null || _p === void 0 ? void 0 : _p.reset();
            (_q = this.metrics) === null || _q === void 0 ? void 0 : _q.reset();
            (_r = this.persistence) === null || _r === void 0 ? void 0 : _r.set_property(constants_1.USER_STATE, constants_1.USER_STATE_ANONYMOUS);
            (_s = this.sessionManager) === null || _s === void 0 ? void 0 : _s.resetSessionId();
            this._cachedPersonProperties = null;
            ...
            if (bootstrap) {
                ...
                if (bootstrap.distinctID !== undefined && !this._inCookielessMode()) {
                    (_t = this.persistence) === null || _t === void 0 ? void 0 : _t.set_property(constants_1.USER_STATE, bootstrap.isIdentifiedID ? constants_1.USER_STATE_IDENTIFIED : constants_1.USER_STATE_ANONYMOUS);
                    this.register({ distinct_id: bootstrap.distinctID });
                }
                (_u = this.featureFlags) === null || _u === void 0 ? void 0 : _u.initialize();
                if (!(0, core_1.isUndefined)(bootstrapSessionID) &&
                    !((_v = this.sessionManager) === null || _v === void 0 ? void 0 : _v.setBootstrapSessionId(bootstrapSessionID, true))) {
            ...
            if (cookieSyncSuppressionStarted) {
                ...
                (_x = (_w = this.persistence) === null || _w === void 0 ? void 0 : _w._endCookieSyncSuppression) === null || _x === void 0 ? void 0 : _x.call(_w, resetCompleted);
            }
        }

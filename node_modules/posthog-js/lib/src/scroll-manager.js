...
var ScrollManager = /** @class */ (function () {
    ...
    ScrollManager.prototype.startMeasuringScrollPosition = function () {
        (0, general_utils_1.addEventListener)(globals_1.window, 'scroll', this._updateScrollData, { capture: true });
        (0, general_utils_1.addEventListener)(globals_1.window, 'scrollend', this._updateScrollData, { capture: true });
        (0, general_utils_1.addEventListener)(globals_1.window, 'resize', this._updateScrollData);
    };

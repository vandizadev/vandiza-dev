...
var ExceptionObserver = /** @class */ (function () {
    function ExceptionObserver(instance) {
        ...
        this._startCapturing = function () {
            var _a;
            if (!globals_1.window || !_this.isEnabled || !((_a = globals_2.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.errorWrappingFunctions)) {
                return;
            }
            var wrapOnError = globals_2.assignableWindow.__PosthogExtensions__.errorWrappingFunctions.wrapOnError;
            var wrapUnhandledRejection = globals_2.assignableWindow.__PosthogExtensions__.errorWrappingFunctions.wrapUnhandledRejection;
            var wrapConsoleError = globals_2.assignableWindow.__PosthogExtensions__.errorWrappingFunctions.wrapConsoleError;
            try {
        ...
        this._rateLimiter = new core_1.BucketedRateLimiter(__assign(__assign({}, (0, core_1.resolveExceptionRateLimiterConfig)(this._instance.config.error_tracking)), { refillInterval: 10000, _logger: logger }));
    ...
    ExceptionObserver.prototype._loadScript = function (cb) {
        var _a, _b, _c;
        if ((_a = globals_2.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.errorWrappingFunctions) {
            // already loaded
            cb();
            return;
        }
        (_c = (_b = globals_2.assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.loadExternalDependency) === null || _c === void 0 ? void 0 : _c.call(_b, this._instance, 'exception-autocapture', function (err) {
            if (err) {
    ...
    ExceptionObserver.prototype.onRemoteConfig = function (result) {
        var _a;
        if (!result.ok) {

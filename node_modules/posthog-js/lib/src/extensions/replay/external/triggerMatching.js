...
function orTriggerStatus(statuses) {
...
function andTriggerStatus(statuses) {
    var enabledStatuses = new Set(statuses);
    // trigger_disabled means no config
    enabledStatuses.delete(exports.TRIGGER_DISABLED);
...
var OrTriggerMatching = /** @class */ (function () {
    ...
    OrTriggerMatching.prototype.triggerStatus = function (sessionId) {
        return orTriggerStatus(this._matchers.map(function (matcher) { return matcher.triggerStatus(sessionId); }));
    };
    OrTriggerMatching.prototype.triggerStatusNoSideEffects = function (sessionId) {
        return orTriggerStatus(this._matchers.map(function (matcher) { return matcher.triggerStatusNoSideEffects(sessionId); }));
    };
...
var AndTriggerMatching = /** @class */ (function () {
    ...
    AndTriggerMatching.prototype.triggerStatus = function (sessionId) {
        return andTriggerStatus(this._matchers.map(function (matcher) { return matcher.triggerStatus(sessionId); }));
    };
    AndTriggerMatching.prototype.triggerStatusNoSideEffects = function (sessionId) {
        return andTriggerStatus(this._matchers.map(function (matcher) { return matcher.triggerStatusNoSideEffects(sessionId); }));
    };
...
var PendingTriggerMatching = /** @class */ (function () {
    ...
    PendingTriggerMatching.prototype.triggerStatusNoSideEffects = function () {
        return exports.TRIGGER_PENDING;
    };
...
var AlwaysActivatedTriggerMatching = /** @class */ (function () {
    ...
    AlwaysActivatedTriggerMatching.prototype.triggerStatusNoSideEffects = function () {
        return exports.TRIGGER_ACTIVATED;
    };
...
var URLTriggerMatching = /** @class */ (function () {
    ...
    URLTriggerMatching.prototype.triggerStatus = function (sessionId) {
        var _a;
        var result = this.triggerStatusNoSideEffects(sessionId);
     ...
     */
    URLTriggerMatching.prototype.triggerStatusNoSideEffects = function (sessionId) {
        return this._urlTriggerStatus(sessionId);
    };
    URLTriggerMatching.prototype.isCurrentUrlBlocked = function () {
...
var LinkedFlagMatching = /** @class */ (function () {
    ...
    LinkedFlagMatching.prototype.triggerStatus = function () {
        var _a;
        var result = this.triggerStatusNoSideEffects();
        this._instance.register_for_session((_a = {},
    ...
    LinkedFlagMatching.prototype.triggerStatusNoSideEffects = function () {
    ...
    LinkedFlagMatching.prototype.onConfig = function (config, onStarted) {
        ...
        if (!(0, core_1.isNullish)(this.linkedFlag) && !this.linkedFlagSeen) {
            ...
            this._flagListenerCleanup = this._instance.onFeatureFlags(function (_flags, variants) {
                ...
                var isNewActivation = linkedFlagMatches && !_this.linkedFlagSeen;
...
var EventTriggerMatching = /** @class */ (function () {
    ...
    // Pure read of the trigger status — see URLTriggerMatching.triggerStatusNoSideEffects.
    EventTriggerMatching.prototype.triggerStatusNoSideEffects = function (sessionId) {
...
var TriggerGroupMatching = /** @class */ (function () {
    ...
    TriggerGroupMatching.prototype.triggerStatusNoSideEffects = function (sessionId) {
        return this._combinedMatching.triggerStatusNoSideEffects(sessionId);
    };
    TriggerGroupMatching.prototype.getPendingTriggerConditions = function (sessionId) {
        if (this.triggerStatusNoSideEffects(sessionId) !== exports.TRIGGER_PENDING) {
            return [];
        }
        var legs = [
            {
        ...
        return legs.filter(function (_a) {
            var status = _a.status;
            return status === exports.TRIGGER_PENDING;
        }).map(function (_a) {
            var label = _a.label;
            return label;
        });

...
var ignorePostHogPaths = function (data, apiHostConfig, isIngestionEndpoint) {
    var _a;
    if (isIngestionEndpoint === null || isIngestionEndpoint === void 0 ? void 0 : isIngestionEndpoint(data.name)) {
        return undefined;
    }
 ...
 */
var buildNetworkRequestOptions = function (instanceConfig, remoteNetworkOptions, isIngestionEndpoint) {
    var config = {
    ...
    var enforcedCleaningFn = function (d) {
        return payloadLimiter(ignorePostHogPaths(removeAuthorizationHeader(d), instanceConfig.api_host, isIngestionEndpoint));
    };

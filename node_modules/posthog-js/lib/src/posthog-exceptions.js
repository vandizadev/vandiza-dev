...
var INJECTED_BROWSER_SCRIPT_GLOBALS = ['__firefox__', '__gCrWeb'];
...
var PostHogExceptions = /** @class */ (function () {
    ...
    PostHogExceptions.prototype._isInjectedBrowserScriptException = function (exceptionList) {
        return exceptionList.some(function (_a) {
            var value = _a.value;
            return (0, core_1.isString)(value) && INJECTED_BROWSER_SCRIPT_GLOBALS.some(function (global) { return value.includes(global); });
        });
    };
